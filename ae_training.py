...
encoder = models.Sequential([
    ...
    layers.LSTM(8112, activation='tanh', return_sequences=True),  # More neurons and return sequences
    layers.LSTM(2028, activation='tanh', return_sequences=True),  # More neurons and return sequences
...
decoder = models.Sequential([
    ...
    layers.LSTM(2028, activation='tanh', return_sequences=True),  # More neurons
    layers.LSTM(8112, activation='tanh', return_sequences=True),  # More neurons
...
if os.path.exists(checkpoint_filepath):
	# Create a batch of dummy data with the correct input shape
	dummy_input = np.zeros((1,) + input_shape)  # Adding batch dimension
