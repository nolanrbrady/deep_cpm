...
#=======================================================
num_subs = len(os.listdir("./timeseries"))
...
for sub_id, sub in enumerate(os.listdir("./timeseries")):

	path = f"./timeseries/{sub}"
...
flat_df.to_csv("./encoded_timeseries.csv", index=False, header=False)
...
print(df.shape)
df.to_csv('./testing_autoencoder_matrix.csv', index=False, header=False)
